        ...
        switch ($act) {
			...
			case 'quenmk':
				if(isset($_POST['guiemail']) && ($_POST['guiemail'])){
					...
					$new_password = generateRandomPassword(); // Hàm để tạo mật khẩu ngẫu nhiên
					
					// Lưu mật khẩu mới vào database (hoặc cập nhật mật khẩu trong trường hợp cần)
					// Code tương ứng để cập nhật mật khẩu mới vào database
					
					// Gọi hàm gửi email từ trang sendmail
					require_once 'mail/sendmail.php';
					sendMailPass($_POST['email'], 'Username', $new_password); // Thay 'Username' bằng tên người dùng thực tế
