        ...
        <?php 
            ...
            ?>
                ...
                ?>
                        ...
                        <p><small>SKU: MTKRY-0'.$id.'</small><br>Sed ex labitur adolescens scriptorem. Te saepe verear tibique sed. Et wisi ridens vix, lorem iudico blandit mel cu. Ex vel sint zril oportere, amet wisi aperiri te cum.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
								<form action="index.php?act=addtocart" method="post">
									...
									<input type="hidden" name="size" id="selected_size" value="" checked> <!-- Đặt tên cho trường input kích thước -->
                    ...
                    <div class="product_actions">
                        <ul>
                            ...
                            <li> <a href="#"><i class="ti-control-shuffle"></i><span>Add to Compare</span></a></li> </ul>
                    </div>
                    <!-- /product_actions -->
                </div>
            </div>
